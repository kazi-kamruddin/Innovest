...
const FundDashCreatePitch = () => {
  ...
  const limits = useMemo(() => ({ title: 120, long: 1200 }), []);
  ...
  return (
    <div className="investment-pitches cpr">
      <div className="cpr-header">
        <div>
          <h2 className="cpr-title">Create a New Pitch</h2>
          <p className="cpr-sub">Share details about your venture so investors can evaluate quickly.</p>
        </div>
        ...
        <fieldset className="cpr-group">
          ...
          <div className="cpr-row">
            <div className="cpr-col-full">
              ...
              />
              <div className="cpr-hint">{chars.the_business}/{limits.long}</div>
            </div>
          </div>
          ...
          <div className="cpr-row">
            <div className="cpr-col-full">
              ...
              />
              <div className="cpr-hint">{chars.the_market}/{limits.long}</div>
            </div>
          </div>
          ...
          <div className="cpr-row">
            <div className="cpr-col-full">
              ...
              />
              <div className="cpr-hint">{chars.progress}/{limits.long}</div>
            </div>
          </div>
          ...
          <div className="cpr-row">
            <div className="cpr-col-full">
              ...
              />
              <div className="cpr-hint">{chars.objective}/{limits.long}</div>
            </div>
          </div>
        </fieldset>
