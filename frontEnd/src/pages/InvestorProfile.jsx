          ...
          <div className="col-md-2 d-flex justify-content-center align-items-center">
            <div
              ...
              style={{
                width: "120px",
                height: "120px",
                borderRadius: "28px", // Make the image container corners rounded
              }}
            >
              <img
                src={profileImageUrl}
                ...
                style={{
                  ...
                  height: "100%",
                  objectFit: "cover",
                  borderRadius: "28px", // Ensure the image corners are also rounded
                }}
              />
            </div>
          </div>
                ...
                <div className="col-md-4 mb-3">
                  <div
                    ...
                    style={{
                      ...
                      height: "50px", // Adjust the height for better alignment
                      borderRadius: "28px", // Rounded corners for the interest areas
                    }}
                  >
